...
#Disables all buttons during the animation is going on
def disable():
    global shuf
    global insert
    global select
    ...
    insert = tk.Button(window, text='Insertion Sort', state=DISABLED)
    select = tk.Button(window, text='Selection Sort', state=DISABLED)
    bubble = tk.Button(window, text='Bubble Sort', state=DISABLED)
    shuf = tk.Button(window, text='Shuffle', state=DISABLED)
